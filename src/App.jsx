...
const FORMS_DB = [
  ...
  },
  {
    ...
    shortTitle: 'Family Petition',
    category: 'Family',
    description: 'Petition for a family member to receive an immigrant visa or adjust status to become a lawful permanent resident. Filed by U.S. citizens or LPRs.',
    ...
    sections: [
      {
        ...
        questions: [
          { id: 'petitioner_status',  label: 'What is your U.S. immigration status?',             hint: 'U.S. citizens may petition for spouses, children, parents, and siblings. LPRs may only petition for spouses and unmarried children.',   type: 'select', required: true,  pdfFieldMapping: 'Pt1Line3_Yes[0]',      options: ['U.S. Citizen', 'Lawful Permanent Resident (LPR)'] },
          { id: 'relationship_type',  label: 'Who are you petitioning for?',                       hint: 'Select the relationship between you (the petitioner) and your relative (the beneficiary).',                                               type: 'select', required: true,  pdfFieldMapping: 'Pt1Line1_Spouse[0]',   options: ['Spouse', 'Parent', 'Child', 'Sibling'] },
          { id: 'child_type',         label: 'What is the legal nature of the child relationship?',hint: 'Select the appropriate legal relationship with the child.',                                                                                type: 'select', required: true,  pdfFieldMapping: 'Pt1Line2_InWedlock[0]',options: ['Born in wedlock', 'Born out of wedlock', 'Stepchild', 'Adopted child'], condition: { field: 'relationship_type', value: 'Child' } },
          { id: 'previously_filed',   label: 'Have you previously filed a petition for this relative?', hint: 'If yes, USCIS may request details about the prior petition.',                                                                       type: 'yes_no', required: true,  pdfFieldMapping: 'Pt1Line4_Yes[0]' },
        ],
      },
      {
        id: 'petitioner_info',
        ...
        questions: [
          { id: 'pet_alien_number',   label: 'Your Alien Registration Number (A-Number, if any)', hint: 'Starts with "A" — 8 or 9 digits. Leave blank if you are a U.S. citizen with no A-Number.',                                             type: 'text',   required: false, pdfFieldMapping: 'Pt2Line1_AlienNumber[0]' },
          { id: 'pet_uscis_account',  label: 'Your USCIS Online Account Number (if any)',          hint: '12-digit number from your myUSCIS account. Leave blank if none.',                                                                        type: 'text',   required: false, pdfFieldMapping: 'Pt2Line2_USCISOnlineActNumber[0]' },
          { id: 'pet_family_name',    label: 'Your family name (last name)',                        hint: 'Exactly as it appears on your U.S. passport or naturalization certificate.',                                                             type: 'text',   required: true,  pdfFieldMapping: 'Pt2Line4a_FamilyName[0]' },
          { id: 'pet_given_name',     label: 'Your given name (first name)',                        hint: '',                                                                                                                                       type: 'text',   required: true,  pdfFieldMapping: 'Pt2Line4b_GivenName[0]' },
          { id: 'pet_middle_name',    label: 'Your middle name (if any)',                           hint: 'Leave blank if you have no middle name.',                                                                                                type: 'text',   required: false, pdfFieldMapping: 'Pt2Line4c_MiddleName[0]' },
          { id: 'pet_other_names',    label: 'Have you used any other legal names?',                hint: 'Include maiden names, aliases, or name changes.',                                                                                        type: 'yes_no', required: true,  pdfFieldMapping: '' },
          { id: 'pet_other_family',   label: 'Other name — family name (last name)',                hint: '',                                                                                                                                       type: 'text',   required: true,  pdfFieldMapping: 'Pt2Line5a_FamilyName[0]', condition: { field: 'pet_other_names', value: 'yes' } },
          { id: 'pet_other_given',    label: 'Other name — given name (first name)',                hint: '',                                                                                                                                       type: 'text',   required: true,  pdfFieldMapping: 'Pt2Line5b_GivenName[0]', condition: { field: 'pet_other_names', value: 'yes' } },
          { id: 'pet_other_middle',   label: 'Other name — middle name (if any)',                   hint: '',                                                                                                                                       type: 'text',   required: false, pdfFieldMapping: 'Pt2Line5c_MiddleName[0]', condition: { field: 'pet_other_names', value: 'yes' } },
          { id: 'pet_city_birth',     label: 'City or town where you were born',                    hint: 'Use the name of the city as it is known today.',                                                                                        type: 'text',   required: true,  pdfFieldMapping: 'Pt2Line6_CityTownOfBirth[0]' },
          { id: 'pet_country_birth',  label: 'Country where you were born',                         hint: 'Use the current country name.',                                                                                                         type: 'text',   required: true,  pdfFieldMapping: 'Pt2Line7_CountryofBirth[0]' },
          { id: 'pet_dob',            label: 'Your date of birth',                                  hint: 'MM/DD/YYYY',                                                                                                                            type: 'date',   required: true,  pdfFieldMapping: 'Pt2Line8_DateofBirth[0]' },
          { id: 'pet_sex',            label: 'Your sex',                                            hint: '',                                                                                                                                       type: 'select', required: true,  pdfFieldMapping: 'Pt2Line9_Male[0]', options: ['Male', 'Female'] },
          // Petitioner SSN not collected — highlighted yellow on PDF (Pt2Line11_SSN[0])
        ],
      },
      {
        id: 'petitioner_address',
        title: 'Your Current Mailing Address',
        questions: [
          { id: 'pet_street',    label: 'Street number and name',                    hint: 'Do not include apt/suite number here.',                                      type: 'text',   required: true,  pdfFieldMapping: 'Pt2Line10_StreetNumberName[0]' },
          { id: 'pet_apt',       label: 'Apt/Ste/Flr number (if any)',               hint: '',                                                                           type: 'text',   required: false, pdfFieldMapping: 'Pt2Line10_AptSteFlrNumber[0]' },
          { id: 'pet_city',      label: 'City or town',                              hint: '',                                                                           type: 'text',   required: true,  pdfFieldMapping: 'Pt2Line10_CityOrTown[0]' },
          { id: 'pet_state',     label: 'State (if in the U.S.)',                    hint: 'Two-letter abbreviation, e.g. CA, TX. Leave blank if outside the U.S.',     type: 'text',   required: false, pdfFieldMapping: 'Pt2Line10_State[0]' },
          { id: 'pet_zip',       label: 'ZIP code (if in the U.S.)',                 hint: '',                                                                           type: 'text',   required: false, pdfFieldMapping: 'Pt2Line10_ZipCode[0]' },
          { id: 'pet_province',  label: 'Province (if outside the U.S.)',            hint: 'Leave blank if you live in the U.S.',                                        type: 'text',   required: false, pdfFieldMapping: 'Pt2Line10_Province[0]' },
          { id: 'pet_postal',    label: 'Postal code (if outside the U.S.)',         hint: '',                                                                           type: 'text',   required: false, pdfFieldMapping: 'Pt2Line10_PostalCode[0]' },
          { id: 'pet_country',   label: 'Country (if outside the U.S.)',             hint: 'Leave blank if you live in the U.S.',                                        type: 'text',   required: false, pdfFieldMapping: 'Pt2Line10_Country[0]' },
        ],
      },
      {
        ...
        questions: [
          { id: 'pet_num_marriages',     label: 'How many times have you been married (including current marriage)?', hint: 'Enter 0 if you have never been married.',                                                                         type: 'text',   required: true,  pdfFieldMapping: 'Pt2Line16_NumberofMarriages[0]' },
          { id: 'pet_marital_status',    label: 'Your current marital status',                                        hint: '',                                                                                                                 type: 'select', required: true,  pdfFieldMapping: 'Pt2Line17_Married[0]', options: ['Single (never married)', 'Married', 'Widowed', 'Divorced', 'Separated', 'Marriage annulled'] },
          { id: 'pet_marriage_date',     label: 'Date of your current marriage',                                      hint: 'MM/DD/YYYY',                                                                                                       type: 'date',   required: true,  pdfFieldMapping: 'Pt2Line18_DateOfMarriage[0]',  condition: { field: 'pet_marital_status', value: 'Married' } },
          { id: 'pet_marriage_city',     label: 'City or town where you married',                                     hint: '',                                                                                                                 type: 'text',   required: true,  pdfFieldMapping: 'Pt2Line19a_CityTown[0]',       condition: { field: 'pet_marital_status', value: 'Married' } },
          { id: 'pet_marriage_state',    label: 'State where you married (if in the U.S.)',                           hint: 'Two-letter abbreviation. Leave blank if married outside the U.S.',                                                type: 'text',   required: false, pdfFieldMapping: 'Pt2Line19b_State[0]',          condition: { field: 'pet_marital_status', value: 'Married' } },
          { id: 'pet_marriage_province', label: 'Province where you married (if outside the U.S.)',                   hint: '',                                                                                                                 type: 'text',   required: false, pdfFieldMapping: 'Pt2Line19c_Province[0]',       condition: { field: 'pet_marital_status', value: 'Married' } },
          { id: 'pet_marriage_country',  label: 'Country where you married',                                          hint: '',                                                                                                                 type: 'text',   required: true,  pdfFieldMapping: 'Pt2Line19d_Country[0]',        condition: { field: 'pet_marital_status', value: 'Married' } },
          { id: 'pet_us_citizen_entry',  label: 'Were you a U.S. citizen when your spouse (the beneficiary) last entered the U.S.?', hint: 'Only answer if petitioning for a spouse.',                                                        type: 'yes_no', required: false, pdfFieldMapping: 'Pt2Line11_Yes[0]',             condition: { field: 'relationship_type', value: 'Spouse' } },
        ],
      },
      {
        id: 'beneficiary_info',
        title: 'About the Beneficiary (Your Relative)',
        questions: [
          { id: 'ben_alien_number',   label: "Beneficiary's Alien Registration Number (A-Number, if any)", hint: 'Leave blank if your relative has never had one.',                                   type: 'text',   required: false, pdfFieldMapping: 'Pt4Line1_AlienNumber[0]' },
          { id: 'ben_uscis_account',  label: "Beneficiary's USCIS Online Account Number (if any)",          hint: '',                                                                                  type: 'text',   required: false, pdfFieldMapping: 'Pt4Line2_USCISOnlineActNumber[0]' },
          { id: 'ben_family_name',    label: "Beneficiary's family name (last name)",                        hint: "Exactly as it appears on their passport.",                                          type: 'text',   required: true,  pdfFieldMapping: 'Pt4Line4a_FamilyName[0]' },
          { id: 'ben_given_name',     label: "Beneficiary's given name (first name)",                        hint: '',                                                                                  type: 'text',   required: true,  pdfFieldMapping: 'Pt4Line4b_GivenName[0]' },
          { id: 'ben_middle_name',    label: "Beneficiary's middle name (if any)",                           hint: '',                                                                                  type: 'text',   required: false, pdfFieldMapping: 'Pt4Line4c_MiddleName[0]' },
          { id: 'ben_other_names',    label: 'Has the beneficiary used any other legal names?',              hint: 'Include maiden names, aliases, and name changes.',                                  type: 'yes_no', required: true,  pdfFieldMapping: '' },
          { id: 'ben_other_family',   label: "Other name — family name",                                     hint: '',                                                                                  type: 'text',   required: true,  pdfFieldMapping: 'P4Line5a_FamilyName[0]',  condition: { field: 'ben_other_names', value: 'yes' } },
          { id: 'ben_other_given',    label: "Other name — given name",                                      hint: '',                                                                                  type: 'text',   required: true,  pdfFieldMapping: 'Pt4Line5b_GivenName[0]',  condition: { field: 'ben_other_names', value: 'yes' } },
          { id: 'ben_other_middle',   label: "Other name — middle name (if any)",                            hint: '',                                                                                  type: 'text',   required: false, pdfFieldMapping: 'Pt4Line5c_MiddleName[0]', condition: { field: 'ben_other_names', value: 'yes' } },
          { id: 'ben_city_birth',     label: "Beneficiary's city or town of birth",                          hint: '',                                                                                  type: 'text',   required: true,  pdfFieldMapping: 'Pt4Line7_CityTownOfBirth[0]' },
          { id: 'ben_country_birth',  label: "Beneficiary's country of birth",                               hint: 'Use the current country name.',                                                    type: 'text',   required: true,  pdfFieldMapping: 'Pt4Line8_CountryOfBirth[0]' },
          { id: 'ben_dob',            label: "Beneficiary's date of birth",                                  hint: 'MM/DD/YYYY',                                                                       type: 'date',   required: true,  pdfFieldMapping: 'Pt4Line9_DateOfBirth[0]' },
          { id: 'ben_sex',            label: "Beneficiary's sex",                                            hint: '',                                                                                  type: 'select', required: true,  pdfFieldMapping: 'Pt4Line9_Male[0]', options: ['Male', 'Female'] },
          // Beneficiary SSN not collected — highlighted yellow on PDF (Pt4Line3_SSN[0])
        ],
      },
      {
        id: 'beneficiary_address',
        title: "Beneficiary's Current Address & Contact",
        questions: [
          { id: 'ben_street',    label: "Street number and name",                         hint: "Beneficiary's current address. Use U.S. address if they are in the U.S.",   type: 'text',   required: true,  pdfFieldMapping: 'Pt4Line11_StreetNumberName[0]' },
          { id: 'ben_apt',       label: 'Apt/Ste/Flr number (if any)',                   hint: '',                                                                             type: 'text',   required: false, pdfFieldMapping: 'Pt4Line11_AptSteFlrNumber[0]' },
          { id: 'ben_city',      label: 'City or town',                                   hint: '',                                                                             type: 'text',   required: true,  pdfFieldMapping: 'Pt4Line11_CityOrTown[0]' },
          { id: 'ben_state',     label: 'State (if in the U.S.)',                          hint: 'Two-letter abbreviation. Leave blank if outside the U.S.',                   type: 'text',   required: false, pdfFieldMapping: 'Pt4Line11_State[0]' },
          { id: 'ben_zip',       label: 'ZIP code (if in the U.S.)',                       hint: '',                                                                             type: 'text',   required: false, pdfFieldMapping: 'Pt4Line11_ZipCode[0]' },
          { id: 'ben_province',  label: 'Province (if outside the U.S.)',                 hint: '',                                                                             type: 'text',   required: false, pdfFieldMapping: 'Pt4Line11_Province[0]' },
          { id: 'ben_postal',    label: 'Postal code (if outside the U.S.)',              hint: '',                                                                             type: 'text',   required: false, pdfFieldMapping: 'Pt4Line11_PostalCode[0]' },
          { id: 'ben_country',   label: 'Country',                                         hint: "Enter beneficiary's home country if they are outside the U.S.",              type: 'text',   required: true,  pdfFieldMapping: 'Pt4Line11_Country[0]' },
          { id: 'ben_phone',     label: "Beneficiary's daytime phone number",              hint: 'Include country code if outside the U.S.',                                   type: 'text',   required: true,  pdfFieldMapping: 'Pt4Line14_DaytimePhoneNumber[0]' },
          { id: 'ben_mobile',    label: "Beneficiary's mobile phone number (if any)",     hint: '',                                                                             type: 'text',   required: false, pdfFieldMapping: 'Pt4Line15_MobilePhoneNumber[0]' },
          { id: 'ben_email',     label: "Beneficiary's email address (if any)",            hint: '',                                                                             type: 'text',   required: false, pdfFieldMapping: 'Pt4Line16_EmailAddress[0]' },
        ],
      },
      {
        id: 'beneficiary_immigration',
        title: "Beneficiary's Immigration Information",
        questions: [
          { id: 'ben_in_us',            label: 'Is the beneficiary currently in the United States?',         hint: 'This determines whether they adjust status in the U.S. or apply at a consulate abroad.',         type: 'yes_no', required: true,  pdfFieldMapping: '' },
          { id: 'ben_class_admission',  label: "Beneficiary's current visa class / immigration status",      hint: 'e.g., B-2, F-1, H-1B. Found on their I-94 at i94.cbp.dhs.gov.',                                type: 'text',   required: false, pdfFieldMapping: 'Pt4Line21a_ClassOfAdmission[0]', condition: { field: 'ben_in_us', value: 'yes' } },
          { id: 'ben_i94',              label: "Beneficiary's I-94 Arrival/Departure Record Number",         hint: 'Find it at i94.cbp.dhs.gov.',                                                                    type: 'text',   required: false, pdfFieldMapping: 'Pt4Line21b_ArrivalDeparture[0]', condition: { field: 'ben_in_us', value: 'yes' } },
          { id: 'ben_arrival_date',     label: "Date beneficiary last arrived in the U.S.",                   hint: 'MM/DD/YYYY — check passport entry stamp or I-94.',                                               type: 'date',   required: false, pdfFieldMapping: 'Pt4Line21c_DateOfArrival[0]',    condition: { field: 'ben_in_us', value: 'yes' } },
          { id: 'ben_status_expires',   label: "Date beneficiary's authorized stay expires (I-94 date)",     hint: 'MM/DD/YYYY — the "Admit Until" date on their I-94.',                                             type: 'date',   required: false, pdfFieldMapping: 'Pt4Line21d_DateExpired[0]',      condition: { field: 'ben_in_us', value: 'yes' } },
          { id: 'ben_passport',         label: "Beneficiary's passport number",                               hint: '',                                                                                                type: 'text',   required: false, pdfFieldMapping: 'Pt4Line22_PassportNumber[0]' },
          { id: 'ben_travel_doc',       label: "Beneficiary's travel document number (if any, other than passport)", hint: 'Leave blank if none.',                                                                   type: 'text',   required: false, pdfFieldMapping: 'Pt4Line23_TravelDocNumber[0]' },
          { id: 'ben_passport_country', label: "Country that issued beneficiary's passport",                  hint: '',                                                                                                type: 'text',   required: false, pdfFieldMapping: 'Pt4Line24_CountryOfIssuance[0]' },
          { id: 'ben_passport_exp',     label: "Beneficiary's passport expiration date",                      hint: 'MM/DD/YYYY',                                                                                     type: 'date',   required: false, pdfFieldMapping: 'Pt4Line25_ExpDate[0]' },
        ],
      },
      {
        ...
        questions: [
          { id: 'ben_num_marriages',     label: "How many times has the beneficiary been married?",                hint: 'Enter 0 if never married.',                                                          type: 'text',   required: true,  pdfFieldMapping: 'Pt4Line17_NumberofMarriages[0]' },
          { id: 'ben_marital_status',    label: "Beneficiary's current marital status",                            hint: '',                                                                                   type: 'select', required: true,  pdfFieldMapping: 'Pt4Line18_MaritalStatus[3]', options: ['Single (never married)', 'Married', 'Widowed', 'Divorced', 'Separated', 'Marriage annulled'] },
          { id: 'ben_spouse_family',     label: "Current spouse's family name (last name)",                        hint: '',                                                                                   type: 'text',   required: false, pdfFieldMapping: 'Pt4Line18a_FamilyName[0]', condition: { field: 'ben_marital_status', value: 'Married' } },
          { id: 'ben_spouse_given',      label: "Current spouse's given name (first name)",                        hint: '',                                                                                   type: 'text',   required: false, pdfFieldMapping: 'Pt4Line18b_GivenName[0]',  condition: { field: 'ben_marital_status', value: 'Married' } },
          { id: 'ben_spouse_middle',     label: "Current spouse's middle name (if any)",                           hint: '',                                                                                   type: 'text',   required: false, pdfFieldMapping: 'Pt4Line18c_MiddleName[0]', condition: { field: 'ben_marital_status', value: 'Married' } },
          { id: 'ben_marriage_date',     label: "Date of beneficiary's current marriage",                          hint: 'MM/DD/YYYY',                                                                        type: 'date',   required: false, pdfFieldMapping: 'Pt4Line19_DateOfMarriage[0]',  condition: { field: 'ben_marital_status', value: 'Married' } },
          { id: 'ben_marriage_city',     label: "City or town where beneficiary married",                          hint: '',                                                                                   type: 'text',   required: false, pdfFieldMapping: 'Pt4Line20a_CityTown[0]',       condition: { field: 'ben_marital_status', value: 'Married' } },
          { id: 'ben_marriage_state',    label: "State where beneficiary married (if in the U.S.)",                hint: 'Two-letter abbreviation. Leave blank if married outside the U.S.',                  type: 'text',   required: false, pdfFieldMapping: 'Pt4Line20b_State[0]',          condition: { field: 'ben_marital_status', value: 'Married' } },
          { id: 'ben_marriage_province', label: "Province where beneficiary married (if outside the U.S.)",        hint: '',                                                                                   type: 'text',   required: false, pdfFieldMapping: 'Pt4Line20c_Province[0]',       condition: { field: 'ben_marital_status', value: 'Married' } },
          { id: 'ben_marriage_country',  label: "Country where beneficiary married",                               hint: '',                                                                                   type: 'text',   required: false, pdfFieldMapping: 'Pt4Line20d_Country[0]',        condition: { field: 'ben_marital_status', value: 'Married' } },
        ],
      },
      {
        ...
        questions: [
          { id: 'pet_phone',  label: 'Your daytime phone number',         hint: 'Include area code.',  type: 'text', required: true,  pdfFieldMapping: 'Pt6Line3_DaytimePhoneNumber[0]' },
          { id: 'pet_mobile', label: 'Your mobile phone number (if any)', hint: '',                   type: 'text', required: false, pdfFieldMapping: 'Pt6Line4_MobileNumber[0]' },
          { id: 'pet_email',  label: 'Your email address (if any)',        hint: '',                   type: 'text', required: false, pdfFieldMapping: 'Pt6Line5_Email[0]' },
        ],
      },
    ],
  },
...
const QUIZ_QUESTIONS = [
  { id: 'q1', label: 'What best describes your situation?',
    options: [
      ...
      { label: 'I want to sponsor a family member for a Green Card', forms: ['I-130'] },
...
const FIELD_DRAW_MAP = {
  ...
  'I-130': {
    // Part 1 — Relationship
    petitioner_status: [
      { f: 'Pt1Line3_Yes[0]', t: 'check', when: 'U.S. Citizen'                    },
      { f: 'Pt1Line3_No[0]',  t: 'check', when: 'Lawful Permanent Resident (LPR)' },
    ],
    relationship_type: [
      { f: 'Pt1Line1_Spouse[0]',   t: 'check', when: 'Spouse'  },
      { f: 'Pt1Line1_Parent[0]',   t: 'check', when: 'Parent'  },
      { f: 'Pt1Line1_Child[0]',    t: 'check', when: 'Child'   },
      { f: 'Pt1Line1_Siblings[0]', t: 'check', when: 'Sibling' },
    ],
    child_type: [
      { f: 'Pt1Line2_InWedlock[0]',    t: 'check', when: 'Born in wedlock'     },
      { f: 'Pt1Line2_OutOfWedlock[0]', t: 'check', when: 'Born out of wedlock' },
      { f: 'Pt1Line2_Stepchild[0]',    t: 'check', when: 'Stepchild'           },
      { f: 'Pt1Line2_AdoptedChild[0]', t: 'check', when: 'Adopted child'       },
    ],
    previously_filed: [
      { f: 'Pt1Line4_Yes[0]', t: 'check', when: 'yes' },
      { f: 'Pt1Line4_No[0]',  t: 'check', when: 'no'  },
    ],
    // Part 2 — Petitioner info
    pet_alien_number:  [{ f: 'Pt2Line1_AlienNumber[0]',           t: 'text' }],
    pet_uscis_account: [{ f: 'Pt2Line2_USCISOnlineActNumber[0]',  t: 'text' }],
    pet_family_name:   [{ f: 'Pt2Line4a_FamilyName[0]',           t: 'text' }],
    pet_given_name:    [{ f: 'Pt2Line4b_GivenName[0]',            t: 'text' }],
    pet_middle_name:   [{ f: 'Pt2Line4c_MiddleName[0]',           t: 'text' }],
    pet_other_family:  [{ f: 'Pt2Line5a_FamilyName[0]',           t: 'text' }],
    pet_other_given:   [{ f: 'Pt2Line5b_GivenName[0]',            t: 'text' }],
    pet_other_middle:  [{ f: 'Pt2Line5c_MiddleName[0]',           t: 'text' }],
    pet_city_birth:    [{ f: 'Pt2Line6_CityTownOfBirth[0]',       t: 'text' }],
    pet_country_birth: [{ f: 'Pt2Line7_CountryofBirth[0]',        t: 'text' }],
    pet_dob:           [{ f: 'Pt2Line8_DateofBirth[0]',           t: 'text' }],
    pet_sex: [
      { f: 'Pt2Line9_Male[0]',   t: 'check', when: 'Male'   },
      { f: 'Pt2Line9_Female[0]', t: 'check', when: 'Female' },
    ],
    // SSN — both petitioner and beneficiary highlighted in yellow (not collected)
    ssn: [
      { f: 'Pt2Line11_SSN[0]', t: 'text' },
      { f: 'Pt4Line3_SSN[0]',  t: 'text' },
    ],
    // Petitioner address
    pet_street:   [{ f: 'Pt2Line10_StreetNumberName[0]', t: 'text' }],
    pet_apt:      [{ f: 'Pt2Line10_AptSteFlrNumber[0]',  t: 'text' }],
    pet_city:     [{ f: 'Pt2Line10_CityOrTown[0]',       t: 'text' }],
    pet_state:    [{ f: 'Pt2Line10_State[0]',             t: 'text' }],
    pet_zip:      [{ f: 'Pt2Line10_ZipCode[0]',           t: 'text' }],
    pet_province: [{ f: 'Pt2Line10_Province[0]',          t: 'text' }],
    pet_postal:   [{ f: 'Pt2Line10_PostalCode[0]',        t: 'text' }],
    pet_country:  [{ f: 'Pt2Line10_Country[0]',           t: 'text' }],
    // Petitioner marital info
    pet_num_marriages: [{ f: 'Pt2Line16_NumberofMarriages[0]', t: 'text' }],
    pet_marital_status: [
      { f: 'Pt2Line17_Single[0]',    t: 'check', when: 'Single (never married)' },
      { f: 'Pt2Line17_Married[0]',   t: 'check', when: 'Married'                },
      { f: 'Pt2Line17_Widowed[0]',   t: 'check', when: 'Widowed'                },
      { f: 'Pt2Line17_Divorced[0]',  t: 'check', when: 'Divorced'               },
      { f: 'Pt2Line17_Separated[0]', t: 'check', when: 'Separated'              },
      { f: 'Pt2Line17_Annulled[0]',  t: 'check', when: 'Marriage annulled'      },
    ],
    pet_marriage_date:     [{ f: 'Pt2Line18_DateOfMarriage[0]', t: 'text' }],
    pet_marriage_city:     [{ f: 'Pt2Line19a_CityTown[0]',      t: 'text' }],
    pet_marriage_state:    [{ f: 'Pt2Line19b_State[0]',          t: 'text' }],
    pet_marriage_province: [{ f: 'Pt2Line19c_Province[0]',       t: 'text' }],
    pet_marriage_country:  [{ f: 'Pt2Line19d_Country[0]',        t: 'text' }],
    pet_us_citizen_entry: [
      { f: 'Pt2Line11_Yes[0]', t: 'check', when: 'yes' },
      { f: 'Pt2Line11_No[0]',  t: 'check', when: 'no'  },
    ],
    // Part 4 — Beneficiary info
    ben_alien_number:   [{ f: 'Pt4Line1_AlienNumber[0]',          t: 'text' }],
    ben_uscis_account:  [{ f: 'Pt4Line2_USCISOnlineActNumber[0]', t: 'text' }],
    ben_family_name:    [{ f: 'Pt4Line4a_FamilyName[0]',          t: 'text' }],
    ben_given_name:     [{ f: 'Pt4Line4b_GivenName[0]',           t: 'text' }],
    ben_middle_name:    [{ f: 'Pt4Line4c_MiddleName[0]',          t: 'text' }],
    ben_other_family:   [{ f: 'P4Line5a_FamilyName[0]',           t: 'text' }],
    ben_other_given:    [{ f: 'Pt4Line5b_GivenName[0]',           t: 'text' }],
    ben_other_middle:   [{ f: 'Pt4Line5c_MiddleName[0]',          t: 'text' }],
    ben_city_birth:     [{ f: 'Pt4Line7_CityTownOfBirth[0]',      t: 'text' }],
    ben_country_birth:  [{ f: 'Pt4Line8_CountryOfBirth[0]',       t: 'text' }],
    ben_dob:            [{ f: 'Pt4Line9_DateOfBirth[0]',          t: 'text' }],
    ben_sex: [
      { f: 'Pt4Line9_Male[0]',   t: 'check', when: 'Male'   },
      { f: 'Pt4Line9_Female[0]', t: 'check', when: 'Female' },
    ],
    // Beneficiary address
    ben_street:   [{ f: 'Pt4Line11_StreetNumberName[0]', t: 'text' }],
    ben_apt:      [{ f: 'Pt4Line11_AptSteFlrNumber[0]',  t: 'text' }],
    ben_city:     [{ f: 'Pt4Line11_CityOrTown[0]',       t: 'text' }],
    ben_state:    [{ f: 'Pt4Line11_State[0]',             t: 'text' }],
    ben_zip:      [{ f: 'Pt4Line11_ZipCode[0]',           t: 'text' }],
    ben_province: [{ f: 'Pt4Line11_Province[0]',          t: 'text' }],
    ben_postal:   [{ f: 'Pt4Line11_PostalCode[0]',        t: 'text' }],
    ben_country:  [{ f: 'Pt4Line11_Country[0]',           t: 'text' }],
    // Beneficiary contact
    ben_phone:  [{ f: 'Pt4Line14_DaytimePhoneNumber[0]', t: 'text' }],
    ben_mobile: [{ f: 'Pt4Line15_MobilePhoneNumber[0]',  t: 'text' }],
    ben_email:  [{ f: 'Pt4Line16_EmailAddress[0]',        t: 'text' }],
    // Beneficiary immigration info
    ben_class_admission:  [{ f: 'Pt4Line21a_ClassOfAdmission[0]', t: 'text' }],
    ben_i94:              [{ f: 'Pt4Line21b_ArrivalDeparture[0]', t: 'text' }],
    ben_arrival_date:     [{ f: 'Pt4Line21c_DateOfArrival[0]',    t: 'text' }],
    ben_status_expires:   [{ f: 'Pt4Line21d_DateExpired[0]',      t: 'text' }],
    ben_passport:         [{ f: 'Pt4Line22_PassportNumber[0]',    t: 'text' }],
    ben_travel_doc:       [{ f: 'Pt4Line23_TravelDocNumber[0]',   t: 'text' }],
    ben_passport_country: [{ f: 'Pt4Line24_CountryOfIssuance[0]', t: 'text' }],
    ben_passport_exp:     [{ f: 'Pt4Line25_ExpDate[0]',           t: 'text' }],
    // Beneficiary marital info
    ben_num_marriages: [{ f: 'Pt4Line17_NumberofMarriages[0]', t: 'text' }],
    // Checkboxes p5: top row y=535 [3]=Single [4]=Married [5]=Widowed; bottom row y=517 [0]=Divorced [2]=Separated [1]=Annulled
    ben_marital_status: [
      { f: 'Pt4Line18_MaritalStatus[3]', t: 'check', when: 'Single (never married)' },
      { f: 'Pt4Line18_MaritalStatus[4]', t: 'check', when: 'Married'                },
      { f: 'Pt4Line18_MaritalStatus[5]', t: 'check', when: 'Widowed'                },
      { f: 'Pt4Line18_MaritalStatus[0]', t: 'check', when: 'Divorced'               },
      { f: 'Pt4Line18_MaritalStatus[2]', t: 'check', when: 'Separated'              },
      { f: 'Pt4Line18_MaritalStatus[1]', t: 'check', when: 'Marriage annulled'      },
    ],
    ben_spouse_family:     [{ f: 'Pt4Line18a_FamilyName[0]',      t: 'text' }],
    ben_spouse_given:      [{ f: 'Pt4Line18b_GivenName[0]',       t: 'text' }],
    ben_spouse_middle:     [{ f: 'Pt4Line18c_MiddleName[0]',      t: 'text' }],
    ben_marriage_date:     [{ f: 'Pt4Line19_DateOfMarriage[0]',   t: 'text' }],
    ben_marriage_city:     [{ f: 'Pt4Line20a_CityTown[0]',        t: 'text' }],
    ben_marriage_state:    [{ f: 'Pt4Line20b_State[0]',           t: 'text' }],
    ben_marriage_province: [{ f: 'Pt4Line20c_Province[0]',        t: 'text' }],
    ben_marriage_country:  [{ f: 'Pt4Line20d_Country[0]',         t: 'text' }],
    // Part 6 — Petitioner contact
    pet_phone:  [{ f: 'Pt6Line3_DaytimePhoneNumber[0]', t: 'text' }],
    pet_mobile: [{ f: 'Pt6Line4_MobileNumber[0]',        t: 'text' }],
    pet_email:  [{ f: 'Pt6Line5_Email[0]',               t: 'text' }],
  },
}
...
function DownloadScreen({ state, dispatch, t }) {
  ...
  const nextStepsMap = {
    ...
    'I-130': [
      { icon: '📋', text: 'File your I-130 with the correct USCIS Lockbox or, if the beneficiary is abroad, with the National Visa Center (NVC) after approval.' },
      { icon: '💵', text: `Pay the ${form.filingFee} filing fee by check, money order, or online at pay.gov.` },
      { icon: '📎', text: 'Include supporting documents: proof of your U.S. citizenship or LPR status, proof of the qualifying relationship (marriage certificate, birth certificate, etc.).' },
      { icon: '⏳', text: 'Processing times vary: immediate relative petitions (spouse, parent, child under 21 of U.S. citizen) are faster; preference categories may wait years for a visa number.' },
      { icon: '🔗', text: 'Track your case and check visa bulletin priority dates at uscis.gov/my-case-status and travel.state.gov.' },
    ],
  }
